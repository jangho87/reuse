...
<%
	...
	String problem_subtype = request.getParameter("problem_subtype");
	String problem_detail_description = request.getParameter("problem_detail_description");
	...
	try {
		...
		stmt.executeUpdate( "INSERT INTO problem(problem_type, problem_subtype, problem_detail_description, asset_name) VALUES ('" 
				+ problem_type + "', '" + problem_subtype + "', '" + problem_detail_description + "', '" + asset_name + "')"); 
