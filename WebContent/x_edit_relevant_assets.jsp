...
<%
	...
	String relevant_assets_type = request.getParameter("relevant_assets_type");
	String relevant_assets_file = request.getParameter("relevant_assets_file");
	...
	try {
		...
		stmt.executeUpdate( "INSERT INTO relevant_asset(relevanct_asset_type, relevanct_asset_file, asset_name) VALUES ('" 
				+ relevant_assets_type + "', '" + relevant_assets_file + "', '" + asset_name + "')"); 
