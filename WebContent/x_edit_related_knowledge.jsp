...
<%
	...
	String related_knowledge_name = request.getParameter("related_knowledge_name");
	...
	try {
		...
		int updatecount = 0;
		updatecount = stmt.executeUpdate("UPDATE related_knowledge SET related_knowledge_name = '" + related_knowledge_name + "' WHERE asset_name = '" + asset_name + "'"); 
