...
<%
	...
	String reuse_guidance_type = request.getParameter("reuse_guidance_type");
	String reuse_guidance_link = request.getParameter("reuse_guidance_link");
	...
	try {
		...
		stmt.executeUpdate( "INSERT INTO reuse_guidance(reuse_guidance_type, reuse_guidance_link, asset_name) VALUES ('" 
				+ reuse_guidance_type + "', '" + reuse_guidance_link + "', '" + asset_name + "')"); 
